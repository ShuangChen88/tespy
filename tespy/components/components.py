...
class valve(component):
    ...
    def attr(self):
        return {'pr': dc_cp(min_val=1e-4, max_val=1),
                ...
                'dp_char': dc_cc(method='default', param='m'),
                'Sirr': dc_simple()}
    ...
    def equations(self):
        ...
        ######################################################################
        # eqation for specified zeta
        if self.zeta.is_set:
            vec_res += [self.zeta_func()]

        ######################################################################
        # equation for specified difference pressure
    ...
    def dp_char_deriv(self):
        r"""
        Calculates the matrix of partial derivatives of the difference pressure
...
class evaporator(component):
    ...
    Note
    ---
    The evaporator and subclasses (desuperheater, condenser) are
    countercurrent heat exchangers. Equations (kA, ttd_u, ttd_l) do not work
    for directcurrent and crosscurrent or combinations of different types.
    ...
    def energy_func(self):
        r"""
        Equation for evaporator energy balance.
